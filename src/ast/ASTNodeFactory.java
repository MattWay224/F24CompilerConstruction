...
public class ASTNodeFactory {
	...
	public ProgNode createProgNode(List<ASTNode> statements, List<ASTNode> finalExpression, int lineOp, int lineClo) {
		return new ProgNode(statements, finalExpression, lineOp, lineClo);
	}
